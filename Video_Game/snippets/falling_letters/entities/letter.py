...
class Letter:
    ...
    def __init__(self, text, font):
        color = (random.randint(cfg_item("letter","colors")[0],cfg_item("letter","colors")[1]),random.randint(cfg_item("letter","colors")[0],cfg_item("letter","colors")[1]),random.randint(cfg_item("letter","colors")[0],cfg_item("letter","colors")[1]))
    ...
    @property #metodo getter del atributo is_alive
    def is_alive(self):
        return self.__is_alive
    
    @is_alive.setter  #metodo setter del atributo is_alive
